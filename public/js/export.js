...
// ==========================================================================
// OnlineProjectPlanner – Export (Excel XLSX + PDF/print)
// Depends on: color-utils.js, app.js (window.appState, window.appUtils)
// Loaded after app.js so that window.appState and window.appUtils are
// available at runtime (export functions are only called on user interaction,
// by which time all scripts have executed).
// ==========================================================================
...
async function exportCSV() {
  ...
  flatRows.forEach(({ entry, depth }) => {
    ...
    const fontColor = U().isColorDark(color) ? 'FFFFFFFF' : 'FF000000';
